 ...
 ******************************************/
public class MyYirenyaoqingpackage {
	String id = "";
	String user_id = "";
	String target_id = "";
	String money = "";
	...
	String payment = "";
	String add_time = "";
	MyYirenyaoqingUserpackage user = null;
	public String getId() {
		return id;
	}
	...
	public MyYirenyaoqingUserpackage getUser() {
		return user;
	}
	public void setUser(MyYirenyaoqingUserpackage user) {
		this.user = user;
	}
