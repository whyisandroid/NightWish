...
import com.timetalent.client.ui.adapter.YirenWorkAdapter.ViewHolder;
 ...
 ******************************************/
public class XingtanWorkAdapter extends BaseAdapter{
	
	private Context mContext;
	private LayoutInflater mInflater;
	AppController controller;
	Mytasklist data = null;
	 ...
	 * @param 
	 */
	public XingtanWorkAdapter(Context mContext,AppController c) {
		...
		new Thread(){
			public void run() {
				controller.mytasklists();
				data = (Mytasklist) controller.getContext().getBusinessData("MytasklistData");
...
//					showMessageTwo(mContext, "对方已完成预定工作，\n星币将转入对方账户？", "完成");
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 1:
					XingtanWorkAdapter.this.notifyDataSetChanged();
				break;
			case 2:
				XingtanWorkAdapter.this.notifyDataSetChanged();
				break;
