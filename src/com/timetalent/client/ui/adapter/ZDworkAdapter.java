 ...
 ******************************************/
public class ZDworkAdapter extends BaseAdapter {

	private LayoutInflater mInflater;
	Followedlist data = null;
	Context mcontext;
	public ZDworkAdapter(Context context){
		this.mInflater = LayoutInflater.from(context);
		this.mcontext = context;
		new Thread(){
			public void run() {
				 AppController.getController(((Activity)ZDworkAdapter.this.mcontext)).mywithdeaw_lists();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			if(data!= null && data.getLists().size() > position){
				convertView = mInflater.inflate(R.layout.my_zhangdan_gongzuo_item,
					    null);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				ZDworkAdapter.this.notifyDataSetChanged();
				break;
			case 2:
				break;
			case 3:
